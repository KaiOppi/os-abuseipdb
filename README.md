...
> **Status:** public beta (v0.4.0). Running in production on three OPNsense boxes. Looking for community testers — please open an issue or a r/opnsense reply with feedback.
...
pkg add https://github.com/KaiOppi/os-abuseipdb/releases/download/v0.4.0/os-abuseipdb-0.4.0.pkg
```
